declare interface from {
    ...
    on(event: "remove", listener: (std: string, modulesArray: Array<string>) => any): from;
    ...
    on(event: "update", listener: (std: string, modules: Array<string>) => any): from;
...
declare namespace from {
    var on: {
        ...
        (event: "remove", listener: (std: string, modulesArray: string[]) => any): from;
    ...
    var once: (event: string | symbol, listener: (...args: any[]) => any) => typeof from;
...
export declare function auditFix(): void;
export declare function update(module: string | Array<string>, yarn: boolean | undefined, callback: (modNames?: Array<string>) => any): void;
/**
