...
exports.version = exports.update = exports.auditFix = exports.has = exports.include = exports.remove = exports.install = void 0;
...
function version(module) {
    var v = JSON.parse(fs_1.default.readFileSync(path_1.default.resolve(path, "./package.json"), "utf-8")).dependencies[module];
    if (v)
        return v;
}
